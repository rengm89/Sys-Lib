...
Public Class frm004Autores
    ...
    Private Sub btnExportar_Click(sender As Object, e As EventArgs) Handles btnExportar.Click
        Dim objArchivo As New StreamWriter("DatosExportados4.csv", False, System.Text.Encoding.UTF8)
        Conexion.ConnectionString = CadenaDeConexion
        Conexion.Open()
    ...
    Private Sub DocumentoImprimir_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles DocumentoImprimir.PrintPage
        ...
        Dim titulo As String = "Autores"



        e.Graphics.DrawString(titulo, LetraTitulo, Brushes.Blue, 80, 40)
        e.Graphics.DrawString("IDAutor", LetraTituloColumna, Brushes.Black, 80, 80)
        e.Graphics.DrawString("Autor", LetraTituloColumna, Brushes.Black, 380, 80)
        ...
        If DR.HasRows Then
            Do While DR.Read
                ...
                e.Graphics.DrawString(DR("IdAutor"), TipoLetra, Brushes.Black, 80, fila)
