...
Public Class frm005Idiomas
    ...
    Private Sub btnExportar_Click(sender As Object, e As EventArgs) Handles btnExportar.Click
        Dim objArchivo As New StreamWriter("DatosExportados5.csv", False, System.Text.Encoding.UTF8)
        Conexion.ConnectionString = CadenaDeConexion
        Conexion.Open()
    ...
    Private Sub DocumentoImprimir_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles DocumentoImprimir.PrintPage
        ...
        Dim titulo As String = "Idiomas"



        e.Graphics.DrawString(titulo, LetraTitulo, Brushes.Blue, 80, 40)
        e.Graphics.DrawString("IDIdioma", LetraTituloColumna, Brushes.Black, 80, 80)
        e.Graphics.DrawString("Idioma", LetraTituloColumna, Brushes.Black, 380, 80)
        ...
        If DR.HasRows Then
            Do While DR.Read
                ...
                e.Graphics.DrawString(DR("IdIdioma"), TipoLetra, Brushes.Black, 80, fila)
