Imports System.IO
Public Class frm011LibroPorPais
    Private Sub btnMostar_Click(sender As Object, e As EventArgs) Handles btnMostar.Click
        Try
            ...
            Comando.CommandText = "Select top 8 * from TitulosPorPais order by CantidadLibro desc"
    ...
    Private Sub btnGrafico_Click(sender As Object, e As EventArgs) Handles btnGrafico.Click
        Try
            ...
            If DR.HasRows Then
                Do While DR.Read
                    Chart1.Series("TitulosPorPais").Points.AddXY(DR("Nombre"), DR("CantidadLibro"))
                Loop
            End If
    ...
    Private Sub btnExportar_Click(sender As Object, e As EventArgs) Handles btnExportar.Click
        Dim objArchivo As New StreamWriter("DatosExportados12.csv", False, System.Text.Encoding.UTF8)
        Conexion.ConnectionString = CadenaDeConexion
        Conexion.Open()
    ...
    Private Sub DocumentoImprimir_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles DocumentoImprimir.PrintPage
        ...
        Dim titulo As String = "Estadísticas por País"



        e.Graphics.DrawString(titulo, LetraTitulo, Brushes.Blue, 80, 40)
        e.Graphics.DrawString("País", LetraTituloColumna, Brushes.Black, 80, 80)
